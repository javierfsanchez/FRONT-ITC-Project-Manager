...
import { FormActividadesComponent } from 'src/app/Forms/form-actividades/form-actividades.component';
...
export class ActividadComponent implements OnInit, AfterViewInit {
  ...
  public get(){
    this.api.get('Actividades').then((res)=>{
  ...
  public deleteRegistro(id: number) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            this.api.delete('Facultades', id.toString(), { activo: "I" }) // Llama al método Put para marcar el estudiante como inactivo
                .then(() => {
                    Swal.fire(
                        'Eliminado!',
