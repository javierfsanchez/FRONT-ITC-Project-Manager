...
import { FromProyectoComponent } from 'src/app/Forms/from-proyecto/from-proyecto.component';
    ...
    public deleteRegistro(id: number) {
      ...
      Swal.fire({
          ...
          if (result.isConfirmed) {
              this.api.delete('Proyectos', id.toString(), { activo: false }) // Llama al método Put para marcar el estudiante como inactivo
                  .then(() => {
                      Swal.fire(
                          'Eliminado!',
